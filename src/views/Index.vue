...
li {
    ...
    width: 100%;
    animation: rotateCW calc(40s) cubic-bezier(0.000, 0.37, 1.000, 0.63) infinite;
}
...
.card {
    ...
    font: 400 14px '';
    color: #535062;
    animation: rotateCCW calc(40s) cubic-bezier(0.000, 0.37, 1.000, 0.63) infinite;
}
...
li:nth-child(2),
li:nth-child(2) .card {
    animation-delay: calc(-6.67s);
}

li:nth-child(3),
li:nth-child(3) .card {
    animation-delay: calc(-13.34s);
}

li:nth-child(4),
li:nth-child(4) .card {
    animation-delay: calc(-20.01s);
}

li:nth-child(5),
li:nth-child(5) .card {
    animation-delay: calc(-26.68s);
}

li:nth-child(6),
li:nth-child(6) .card {
    animation-delay: calc(-33.35s);
}
...
.second-circle {
    ...
    box-shadow: 0px 18px 36px -18px rgba(12, 5, 46, 0.3),
        0px 30px 60px -12px rgba(12, 5, 46, 0.25);
    border-radius: 50%;
    background-image: url(../static/gif/03.gif);
}
